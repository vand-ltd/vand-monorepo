...
import { LOGO_DARK_PATH, CONTACT_EMAIL, BRAND_NAME } from '@/lib/brand';
          ...
          <div className="space-y-4">
            <a href={`mailto:${CONTACT_EMAIL}`} className="flex items-center gap-3 group">
              ...
              <div>
                ...
                <div className="text-sm text-brand-secondary group-hover:text-brand-accent transition-colors">{CONTACT_EMAIL}</div>
              </div>
            </a>
...
export async function generateMetadata() {
  return {
    ...
    description: `Learn about ${BRAND_NAME}, our mission for independent journalism from Rwanda and around the world.`,
  };
}
