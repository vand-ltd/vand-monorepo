        ...
        <Card>
          <CardContent className="p-5 flex items-start gap-4">
            ...
            <div>
              ...
              <a href={`mailto:${CONTACT_EMAIL}`} className="text-sm text-brand-secondary hover:text-brand-accent transition-colors">{CONTACT_EMAIL}</a>
        ...
        <div className="p-6" style={{ background: 'linear-gradient(135deg, #003153, #005F73)' }}>
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <a
                href={`mailto:${CONTACT_EMAIL}?subject=Story%20Tip`}
...
export async function generateMetadata() {
  return {
    ...
    description: `Get in touch with ${BRAND_NAME}. Send us story tips, feedback, or business inquiries.`,
  };
}
